...
const { sqlConvert } = require("../helpers/sql");
const {
  NotFoundError,
  BadRequestError,
  UnauthorizedError,
...
class User {
  ...
  /** Given a username and a jobID, add new job application to the application table.
 *
 * Returns { applied: jobID }
 *
 * Throws NotFoundError if there is a duplicate.
 **/
  ...
  static async update(username, data) {
    ...
    const { setCols, values } = sqlConvert(
      data,
      {
